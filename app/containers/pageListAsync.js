...
export const ViewBusiness = Loadable({
  loader: () => import('./Pages/ViewBusiness'),
  loading: Loading,
});
export const RegisterBusiness = Loadable({
  loader: () => import('./Pages/RegisterBusiness'),
  loading: Loading,
});
export const ViewProperty = Loadable({
  loader: () => import('./Pages/ViewProperty'),
  loading: Loading,
});
export const RegisterProperty = Loadable({
  loader: () => import('./Pages/RegisterProperty'),
  loading: Loading,
});
